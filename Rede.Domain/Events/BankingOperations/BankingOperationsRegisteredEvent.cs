...
public class BankingOperationsRegisteredEvent : Event
    {
        public BankingOperationsRegisteredEvent(Guid id, string originAccount, string destinationAccount, double amount, string operation)
        {
            Id = id;
