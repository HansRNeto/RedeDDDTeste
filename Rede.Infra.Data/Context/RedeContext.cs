...
public class RedeContext : DbContext
    {
        public RedeContext(DbContextOptions<RedeContext> options) : base(options)
        {
        }

        public DbSet<Customer> Customers { get; set; }
        public DbSet<CurrencyAccount> CurrencyAccounts { get; set; }
        public DbSet<BankingOperations> BankingOperations { get; set; }


        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.ApplyConfiguration(new CustomerMap());
            modelBuilder.ApplyConfiguration(new CurrencyAccountMap());
            modelBuilder.ApplyConfiguration(new BankingOperationsMap());
