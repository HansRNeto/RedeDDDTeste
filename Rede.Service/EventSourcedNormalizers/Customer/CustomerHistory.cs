...
namespace Rede.Service.EventSourcedNormalizers.Customer;
        ...
        public static IList<CustomerHistoryData> ToJavaScriptCustomerHistory(IList<StoredEvent> storedEvents)
        {
            ...
            foreach (var change in sorted)
            {
                var jsSlot = new CustomerHistoryData
                {
                    ...
                    Document = string.IsNullOrWhiteSpace(change.Document) || change.Document == last.Document
                        ? ""
                        : change.Document,
